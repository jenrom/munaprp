...
namespace nothinbutdotnetprep.infrastructure.filtering
{
    ...
    {
        public static Criteria<ItemToMatch> equal_to<ItemToMatch, PropertyType>(
            this IProvideAccessToSpecificationFactories<ItemToMatch, PropertyType> extension_point, PropertyType value)
        {
            return equal_to_any(extension_point, value);
        }

        public static Criteria<ItemToMatch> equal_to_any<ItemToMatch, PropertyType>(
            this IProvideAccessToSpecificationFactories<ItemToMatch, PropertyType> extension_point,
            params PropertyType[] values)
        {
            return extension_point.create_criteria_from(new EqualToAny<PropertyType>(values));
        }
        ...
        {
            return extension_point.create_criteria_from(new FallsInRange<PropertyType>(new RangeWithNoUpperBound<PropertyType>(value))
        ...
        {
            return extension_point.create_criteria_from(new FallsInRange<PropertyType>(new RangeWithNoLowerBound<PropertyType>(value))
                               .or(new EqualToAny<PropertyType>(value)));
        }
